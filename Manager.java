...
public class Manager {
  ...
  boolean manager_deleteCustomer (int customerId) {
    Customer customerPtr;
    RBTree reservationTables[]=new RBTree[DefinesLock.NUM_RESERVATION_TYPE];
    ...
    reservationTables[DefinesLock.RESERVATION_CAR] = carTablePtr;
    reservationTables[DefinesLock.RESERVATION_ROOM] = roomTablePtr;
    reservationTables[DefinesLock.RESERVATION_FLIGHT] = flightTablePtr;
  ...
  boolean manager_reserveFlight (int customerId, int flightId) {
    return reserve(flightTablePtr,
                   ...
                   customerId,
                   flightId,
                   DefinesLock.RESERVATION_FLIGHT);
  }
