...
public final static int PARAM_DEFAULT_RELATIONS  = (40000);//(5000);//(10000);//1<<16
public final static int PARAM_DEFAULT_TRANSACTIONS= (3000);//(20000);//(50000); //(1 << 26);
public final static int PARAM_DEFAULT_USER        = (0);
