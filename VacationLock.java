...
public class VacationLock {
  ...
  public void setDefaultParams () {
    CLIENTS      = DefinesLock.PARAM_DEFAULT_CLIENTS;
    NUMBER       = DefinesLock.PARAM_DEFAULT_NUMBER;
    QUERIES      = DefinesLock.PARAM_DEFAULT_QUERIES;
    RELATIONS    = DefinesLock.PARAM_DEFAULT_RELATIONS;
    TRANSACTIONS = DefinesLock.PARAM_DEFAULT_TRANSACTIONS;
    USER         = DefinesLock.PARAM_DEFAULT_USER;
  }
  ...
  public static void main(String[] argv) {
    ...
    VacationLock vac=new VacationLock();
    vac.parseArgs(argv);
